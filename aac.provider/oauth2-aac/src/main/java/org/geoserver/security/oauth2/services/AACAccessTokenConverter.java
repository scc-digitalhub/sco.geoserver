 ...
 */
public class AACAccessTokenConverter extends DefaultAccessTokenConverter {

    private UserAuthenticationConverter userTokenConverter;

    public AACAccessTokenConverter() {
        final DefaultUserAuthenticationConverter defaultUserAuthConverter = new AACUserAuthenticationConverter(
                "email");
