 ...
 *
 */
public class AACOAuth2AuthenticationProvider extends GeoServerOAuthAuthenticationProvider {

    public AACOAuth2AuthenticationProvider(
    ...
    public void configure(XStreamPersister xp) {
        xp.getXStream().alias("aacOauth2Authentication", AACOAuth2FilterConfig.class);
    }

    @Override
    public Class<? extends GeoServerSecurityFilter> getFilterClass() {
        return AACOAuthAuthenticationFilter.class;
    }
    
    @Override
    public GeoServerSecurityFilter createFilter(SecurityNamedServiceConfig config) {
        return new AACOAuthAuthenticationFilter(config, tokenServices,
