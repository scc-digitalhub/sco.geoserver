...
public class OAuth2FilterConfigValidatorTest extends GeoServerMockTestSupport {
    ...
    public void testOAuth2FilterConfigValidation() throws Exception {
        AACOAuth2FilterConfig config = new AACOAuth2FilterConfig();
    ...
    public void check(AACOAuth2FilterConfig config) throws Exception {
        ...
        assertTrue(failed);
        config.setLogoutUri("http://localhost:10000/gesoerver");
